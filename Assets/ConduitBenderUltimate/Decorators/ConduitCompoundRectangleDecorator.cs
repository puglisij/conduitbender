...
public class ConduitCompoundRectangleDecorator : AConduitDecorator
{
    ...
    public override void Decorate()
    {
        ...
        var height = (float) bend.GetInputParameter(EBendParameterName.Height).value;
        var length = (float) bend.GetInputParameter(EBendParameterName.Length).value;

        // Set Obstacle Position
        Vector3 oPos;
                oPos.x = -k_objstacleLength * 0.5f + conduitRadius;
                oPos.y = 0.5f * height - conduitRadius;
                oPos.z = centerline[ indices[ 3 ].index ].point.z - (length * 0.5f) + conduitRadius;
        m_obstacle.transform.localScale = new Vector3( k_objstacleLength, height, length );
    ...
    public override void Set( Conduit conduit )
    {
        ...
        // Create Obstacle
        m_obstacle = GameObject.CreatePrimitive( PrimitiveType.Cube );
        ...
        m_obstacle.transform.localPosition = new Vector3( 0f, 0f, 0f );
    }
}
